  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <div className="flex items-start gap-3">
          <p className="text-gray-600">
            WISHFUL GENERAL TRADING İTHALAT İHRACAT TİC. LTD. ŞTİ.
          </p>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              UAE, Türkiye, KSA, Egypt, UK, Canada
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          <Mail className="mt-0.5 h-5 w-5 flex-shrink-0 text-gray-600" />
          <div>
      ...
      <div className="mt-4 border-t pt-6">
        <h3 className="mb-3 font-medium">Sosyal Medya</h3>
        <div className="flex gap-4">
          <a
            href="https://instagram.com/animalwishbox"
            target="_blank"
            rel="noreferrer"
          ...
          {/* <a 
            href="https://facebook.com/animalwishbox" 
            target="_blank" 
            rel="noreferrer" 
            className="text-gray-500 hover:text-gray-900"
          >
          ...
          <a 
            href="https://twitter.com/animalwishbox" 
            target="_blank" 
            rel="noreferrer" 
            className="text-gray-500 hover:text-gray-900"
          >
      ...
      {/* <div className="mt-6">
        <div className="aspect-[4/3] w-full overflow-hidden rounded-lg">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.1896954161767!2d55.37910847611118!3d25.118311077781612!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f63830e5349e1%3A0x8a7e13485d414c1b!2sDubai%20Silicon%20Oasis!5e0!3m2!1str!2sae!4v1711039481056!5m2!1str!2sae"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
