  ...
  return (
    <button
      ...
      className={cn(
        ...
        // light mode colors - #0F52BA (Safir Mavisi) kullanarak
        "bg-[linear-gradient(#0F52BA,#0F52BA),linear-gradient(#0F52BA_50%,rgba(15,82,186,0.6)_80%,rgba(15,82,186,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        // dark mode colors
